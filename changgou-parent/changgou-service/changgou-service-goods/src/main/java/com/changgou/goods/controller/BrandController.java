...
public class BrandController {
    ...
    public Result<List<Brand>> findByCategoryId(@PathVariable(value = "categoryId") Integer categoryId){
        List<Brand> brandList = brandService.findByCategoryId(categoryId);
        return new Result<>(true,StatusCode.OK,"根据分类id查询所有的品牌数据集合成功",brandList);
    }
